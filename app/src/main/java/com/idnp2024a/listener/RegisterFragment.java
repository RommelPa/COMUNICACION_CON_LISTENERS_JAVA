...
public class RegisterFragment extends Fragment {
    ...
    private EditText edtNombres, edtApellidos, edtCorreo, edtTelefono, edtContrasena;
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener != null) {
                    ...
                    Usuario nuevoUsuario = new Usuario(nombres, apellidos, correo, telefono, contrasena);
                    mListener.onFragmentInteraction(nuevoUsuario);
                }
            }
        });
        return view;
